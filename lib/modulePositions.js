...
const desktop = {
  Receipt:        { offset: { x: -17.6, y: -45 }, scale: { x: 1.041, y: 1.041 } },
  WeatherClock:   { offset: { x: -34.6, y: 0.5 }, scale: { x: 1.041, y: 1.041 } },
  NicknameTag:    { offset: { x: 805.7, y: 387.2 }, scale: { x: 1.003, y: 1.003 }, rotation: -1.4 },
  ShelfPanel:     { offset: { x: 196.4, y: 32.9 }, scale: { x: 0.727, y: 0.727 } },
  PaperPanel:     { offset: { x: -81.1, y: -103 }, size: { width: 806.9, height: 779.1 } },
