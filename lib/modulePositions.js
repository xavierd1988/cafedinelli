...
const desktop = {
  Receipt:        { offset: { x: -19.1, y: -48.8 }, scale: { x: 1.041, y: 1.041 } },
  WeatherClock:   { offset: { x: -37.5, y: 0.5 }, scale: { x: 1.041, y: 1.041 } },
  NicknameTag:    { offset: { x: 820.4, y: 389.2 }, scale: { x: 1.087, y: 1.087 }, rotation: -1.4 },
  ShelfPanel:     { offset: { x: 196.4, y: 32.9 }, scale: { x: 0.727, y: 0.727 } },
  PaperPanel:     { offset: { x: 812, y: -136.2 }, size: { width: 805.4, height: 821.8 } },
  ...
  SeatsCounter:   { offset: { x: 1100, y: 380 }, scale: { x: 1, y: 1 } },
