...
const desktop = {
  Receipt:        { offset: { x: -23.4, y: -59.7 }, scale: { x: 0.873, y: 0.873 } },
  WeatherClock:   { offset: { x: -16.5, y: -12.5 }, scale: { x: 0.873, y: 0.873 } },
  ...
  PixooMuteCat:     { offset: { x: 1102.6, y: 214.1 }, size: { width: 49.2, height: 65.8 } }
};
