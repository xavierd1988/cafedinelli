...
const desktop = {
  ...
  NicknameTag:    { offset: { x: 736, y: 389.9 }, scale: { x: 1, y: 1 }, rotation: -1.4 },
  ShelfPanel:     { offset: { x: 196.4, y: 32.9 }, scale: { x: 0.727, y: 0.727 } },
  PaperPanel:     { offset: { x: 53.3, y: -116.4 }, size: { width: 685.8, height: 870.9 } },
  ...
  BlackBackdrop:  { offset: { x: 1357.7, y: 362.2 }, size: { width: 380.7, height: 406 } }
};
