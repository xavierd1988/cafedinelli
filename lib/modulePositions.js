...
const desktop = {
  Receipt:        { offset: { x: -20.7, y: -52.9 }, scale: { x: 1.041, y: 1.041 } },
  WeatherClock:   { offset: { x: -14.7, y: -11 }, scale: { x: 1.041, y: 1.041 } },
  NicknameTag:    { offset: { x: 813.3, y: 357.8 }, scale: { x: 1.132, y: 1.132 }, rotation: -1.4 },
  ShelfPanel:     { offset: { x: 179.4, y: 2.5 }, scale: { x: 0.516, y: 0.516 } },
  ...
  CashRegister:   { offset: { x: 466.9, y: 91.1 }, scale: { x: 0.354, y: 0.354 } },
  RadioCabinet:   { offset: { x: 317.4, y: 85.2 }, scale: { x: 0.4, y: 0.4 } },
