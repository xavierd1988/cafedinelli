...
const desktop = {
  Receipt:        { offset: { x: -18.3, y: -17.4 }, scale: { x: 0.981, y: 0.981 } },
  WeatherClock:   { offset: { x: -2.3, y: -13.4 }, scale: { x: 0.981, y: 0.981 } },
  NicknameTag:    { offset: { x: 708.7, y: 375.4 }, scale: { x: 0.963, y: 0.963 }, rotation: -1.4 },
  ShelfPanel:     { offset: { x: 196.4, y: 32.9 }, scale: { x: 0.727, y: 0.727 } },
  PaperPanel:     { offset: { x: -67, y: -149.1 }, size: { width: 775, height: 872.3 } },
